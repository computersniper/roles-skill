...
你可以让爱因斯坦接着写相对论，让某个作家接着写未完成的小说，让李白来到现代写新诗，让梅西教你踢足球——**创造无限可能**。
...
> 🎯 **项目愿景**：**把全世界所有角色都装进这个仓库**。现在已有 **44 个**，角色仍在不断增加中...

本仓库已经预置了 **44 个常用角色**，开箱即用，克隆后直接调用。你也可以用 `/create-role` 继续创建更多。
