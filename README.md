...
**把 Claude 变成一个真正强大的工具，可以容纳古今中外、过去现在未来所有角色。**

你可以让爱因斯坦接着推导相对论，让某个作家续写未完成的小说，让李白来到现代写新诗，让健身教练给你制定计划——**创造无限可能**。
...
> 🎯 **项目愿景**：**把全世界所有角色都装进这个仓库**。现在已有 **66 个**，角色仍在不断增加中...

本仓库已经预置了 **66 个常用角色**，开箱即用，克隆后直接调用。你也可以用 `/create-role` 继续创建更多。
...
我们的目标是**把全世界所有角色都装进这个仓库**，现在已有 66 个，还在不断增加中！
